...
# Load the Excel file
xlsx_file_path = 'https://doc.prots.kz/sip/viamedis/excel/phonebook/БазаОСАстана.xlsx'
...
filtered_xlsx_path = 'https://doc.prots.kz/sip/viamedis/excel/phonebook/filtered_data.xlsx'
filtered_xml_path = 'https://doc.prots.kz/sip/viamedis/excel/phonebook/filtered_data.xml'
